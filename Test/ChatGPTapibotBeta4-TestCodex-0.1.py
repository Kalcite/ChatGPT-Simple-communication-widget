...
test1 = "\033[1;34m新增内容：Code-X支持\nCodex 模型系列是 GPT-3 系列的后代，该系列经过自然语言和数十亿行代码的训练。\n它最擅长Python，精通十几种语言，包括JavaScript，Go，Perl，PHP，Ruby，Swift，TypeScript，SQL甚至Shell。\n在最初的有限测试期内，Codex 使用是免费的。\n详情页https://platform.openai.com/docs/models/codex\033[0m"
print()
print(test1)
print()
tp1 = "\033[1;33m请从下列模型中选择你想使用的模型\n[text-ada-001]\n[text-babbage-001]\n[text-curie-001]\n[text-davinci-002]\n[text-davinci-003(推荐)\n[code-davinci-002](Test)(Free)\n[code-cushman-001](test)(Free)\033[0m"
print(tp1)
